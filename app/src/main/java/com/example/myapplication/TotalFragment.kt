...
class TotalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        listView = view.findViewById(R.id.totalListView)
    ...
    fun addTodoItem(todoItem: String) {
        ...
        // 추가: TotalFragment에서 할일이 추가될 때 ViewModel을 업데이트
        sharedViewModel.setAllTodoItems(items)
    }
    ...
    private fun loadTodoItems() {
        ...
        items.clear()
        items.addAll(savedItems ?: emptySet())

        //추가: ViewModel에 할일 목록 업데이트
        //sharedViewModel.setTodoItems(items)
    }
    ...
    private fun showDeleteConfirmationDialog(position: Int) {
        ...
        okButton.setTypeface(customFont, Typeface.BOLD)
        noButton.setTypeface(customFont, Typeface.BOLD)
